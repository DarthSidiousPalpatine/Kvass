...
public class ItemSetup extends TFCItems{
	...
	{
		kvass = new ProperItemAlcohol(1000).setAlcoholContent(0.005f).setTier(2).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Grain).setCalories(0.25f).setWaterRestoreRatio(1.5f).setHeatProtection(600).setColdProtection(0).setUnlocalizedName("Kvass").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemAlcohol) kvass);
		sbiten = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.500f).setWaterRestoreRatio(0.500f).setHeatProtection(150).setColdProtection(900).setUnlocalizedName("Sbiten").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) sbiten);
		syrup = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(1f).setWaterRestoreRatio(0.15f).setHeatProtection(0).setColdProtection(300).setUnlocalizedName("Syrup").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) syrup);
		tarhun = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.1f).setWaterRestoreRatio(1.5f).setHeatProtection(300).setColdProtection(0).setUnlocalizedName("Tarhun").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) tarhun);
		gogolmogol = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Protein).setCalories(1f).setWaterRestoreRatio(0.25f).setHeatProtection(0).setColdProtection(300).setUnlocalizedName("Gogol-Mogol").setCreativeTab(TFCTabs.TFC_FOODS);
		...
		//Teas
		tea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.1f).setWaterRestoreRatio(1f).setHeatProtection(300).setColdProtection(300).setUnlocalizedName("Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		...
		teamushroom = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Grain).setCalories(0.25f).setWaterRestoreRatio(0.750f).setHeatProtection(600).setColdProtection(600).setUnlocalizedName("Tea Mushroom").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) teamushroom);
		appletea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Apple Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) appletea);
		lemontea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Lemon Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) lemontea);
		cherrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Cherry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) cherrytea);
		blueberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Blueberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) blueberrytea);
		raspberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Raspberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) raspberrytea);
		strawberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Strawberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) strawberrytea);
		blackberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Blackberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) blackberrytea);
		cranberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Cranberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) cranberrytea);
		gooseberrytea = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Vegetable).setCalories(0.2f).setWaterRestoreRatio(1.250f).setHeatProtection(450).setColdProtection(450).setUnlocalizedName("Gooseberry Tea").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) gooseberrytea);
		
		//Compotes
		applecompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Apple Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) applecompote);
		plumcompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Plum Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) plumcompote);
		strawberrycompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Strawberry Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) strawberrycompote);
		gooseberrycompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Gooseberry Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) gooseberrycompote);
		blueberrycompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Blueberry Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) blueberrycompote);
		raspberrycompote = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1.5f).setHeatProtection(400).setColdProtection(0).setUnlocalizedName("Raspberry Compote").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) raspberrycompote);
		
		//Morses
		grapemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Grape Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) grapemors);
		agavemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Agave Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) agavemors);
		canemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Cane Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) canemors);
		applemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Apple Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) applemors);
		orangemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Orange Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) orangemors);
		lemonmors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Lemon Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) lemonmors);
		cherrymors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Cherry Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) cherrymors);
		plummors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Plum Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) plummors);
		peachmors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Peach Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) peachmors);
		datemors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Date Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) datemors);
		papayamors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Papaya Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) papayamors);
		figmors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Fig Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) figmors);
		berrymors = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(0.750f).setWaterRestoreRatio(1f).setHeatProtection(1200).setColdProtection(0).setUnlocalizedName("Berry Mors").setCreativeTab(TFCTabs.TFC_FOODS);
		drinks.add((ProperItemDrink) berrymors);
		
		//Kisels
		kissel = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(1.500f).setWaterRestoreRatio(0.750f).setHeatProtection(0).setColdProtection(800).setUnlocalizedName("Kissel").setCreativeTab(TFCTabs.TFC_FOODS);
		...
		fruitkissel = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(1.750f).setWaterRestoreRatio(0.750f).setHeatProtection(0).setColdProtection(1200).setUnlocalizedName("Fruit Kissel").setCreativeTab(TFCTabs.TFC_FOODS);
		...
		berrykissel = new ProperItemDrink(1000).setCanDrinkInParts(true).setFoodGroup(EnumFoodGroup.Fruit).setCalories(1.750f).setWaterRestoreRatio(0.750f).setHeatProtection(0).setColdProtection(1200).setUnlocalizedName("Berry Kissel").setCreativeTab(TFCTabs.TFC_FOODS);
